	...
	*/
	$.wysiwyg.controls.link = {
		init: function (Wysiwyg) {
			var self = this, adialog, a, selection,
			...
			formLinkHtml = '<form class="wysiwyg" id="wysiwyg-addLink"><fieldset><legend>{legend}</legend>' +
				'<label>{url}: <input type="text" name="linkhref" value=""/></label><br />' +
				'<label>{title}: <input type="text" name="linktitle" value=""/></label><br />' +
				'<!--label>{target}: <input type="text" name="linktarget" value=""/></label-->' +
				'<input type="submit" class="submit" value="{submit}"/> ' +
				'<input type="reset" class="submit" value="{reset}"/></fieldset></form>';
			...
			adialog = new $.wysiwyg.dialog(Wysiwyg, {
				...
				"open"    : function (e, dialog) {
					dialog.find("form#wysiwyg-addLink").submit(function (e) {
						e.preventDefault();
						var url = $('input[name="linkhref"]', dialog).val(),
						title = $('input[name="linktitle"]', dialog).val(),
						target = '_blank',/*$('input[name="linktarget"]', dialog).val(),*/
						baseUrl,
						img;
