		...
		<form id="manageForm" action="admin-link-manage.html" method="post">
			<table cellspacing="0" cellpadding="0" border="0"><!-- Table -->
				...
				<tbody>
					...
					<tr<#if i = 0> class="alt"<#assign i = 1><#else><#assign i = 0></#if>>
						...
						<td>
							<a href="admin-link-edit-${item.itemId?c}.html"><img src="${staticServePath}include/image/action_edit.png" alt="编辑" /></a>
			...
			<fieldset>
				<div class="input_field no_margin_bottom">
					...
					<input class="submit" type="button" value="添加新的链接" onclick="location.href='admin-link-add.html'" />
				</div>
			</fieldset>
		...
		<#else>
			<div class="warning">
				...
				<div class="desc">
					...
					<p>赶快 <a class="button" href="admin-link-add.html">添加新的链接</a> 吧!</p>
				</div>
			</div>
