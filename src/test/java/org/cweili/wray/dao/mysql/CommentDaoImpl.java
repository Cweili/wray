...
//		int r = db.update("UPDATE comment SET stat=? WHERE comment_id=?",
//				new PreparedStatementSetter() {
//					@Override
//					public void setValues(PreparedStatement ps) throws SQLException {
...
//	 * (non-Javadoc)
//	 * 
//	 * @see org.cweili.wray.dao.CommentDao#getComments(byte, int, int,
//	 * java.lang.String)
//	 */
//	@Override
...
//		db.query(
//				"SELECT comment_id, article_id, author, email, link, ip, post_time, agent, content, parrent_id, "
//						+ "stat FROM comment WHERE stat=? ORDER BY " + order + " LIMIT ?,?",
//				new Object[] { status, start, limit }, new int[] { Types.INTEGER, Types.INTEGER,
//						Types.INTEGER }, new RowCallbackHandler() {
//					@Override
//					public void processRow(ResultSet rs) throws SQLException {
//						Comment comment = new Comment(rs.getLong(1), rs.getLong(2),
//								rs.getString(3), rs.getString(4), rs.getString(5), rs.getString(6),
//								rs.getTimestamp(7), rs.getString(8), rs.getString(9), rs
//										.getLong(10), rs.getByte(11));
//						list.add(comment);
//					}
//				});
...
//	 * 
//	 * @see
//	 * org.cweili.wray.dao.CommentDao#getCommentsByArticle(org.cweili.wray.domain
//	 * .Article)
//	 */
//	@Override
...
//				new Object[] { article.getArticleId() }, new int[] { Types.BIGINT },
